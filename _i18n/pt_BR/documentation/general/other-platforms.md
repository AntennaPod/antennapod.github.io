Por mais atraente que o título possa parecer, o AntennaPod não está e não estará disponível para Windows, iOS ou Linux. O aplicativo é desenvolvido por uma pequena equipe de voluntários, e adaptar o app para essas outras plataformas daria muito trabalho.

Ainda assim, existem alternativas (de código aberto) que gostaríamos de indicar:
...
Tem alguma recomendação de app de podcast de código aberto para essas plataformas? [Conte pra gente lá no fórum!](https://forum.antennapod.org)

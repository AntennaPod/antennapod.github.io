...
Als AntennaPod bijgewerkt is en je ons forum tevergeefs doorzocht hebt, informeer ons dan over het probleem. Maak een bericht [op ons forum](https://forum.antennapod.org/c/bug-report/9). Hiervoor moet je een account aanmaken (als je er nog geen hebt) of inloggen via Google.

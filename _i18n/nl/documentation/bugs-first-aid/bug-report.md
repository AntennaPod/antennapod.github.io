Een bug tegengekomen? Het spijt ons te horen.
...
Als AntennaPod bijgewerkt is en je ons forum tevergeefs doorzocht hebt, vertel ons dan over het probleem. Maak een bericht op [op ons forum](https://forum.antennapod.org/c/bug-report/9). Om dit te doen, moet je een account aanmaken (als je er nog geen hebt) of inloggen via Google.

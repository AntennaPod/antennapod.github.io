...
در این بافتار می‌دانیم هر گزینه‌ای که می‌افزاییم به معنای انتخابی انجام‌نشده است؛ انتخابی که به کاربر واگذار می‌شود. ([این‌جا فرسته‌ای بی‌نظیر](http://neugierig.org/software/blog/2018/07/options.html) درباره این وجود دارد که چرا توسعه‌دهندگان نباید این کار را بکنند. قول می‌دهیم بهترین تصمیم‌ها را برای تجربه‌ای عالی بگیریم؛ چرا که - هنوز تصمیم گرفته‌اید امشب شام چی بخورید؟
...
آنتناپاد همچون دیگر نرم‌افزارهای برجسته چون فایرفاکس و سیگنال، نرم‌افزار آزاد است. یعنی هرکسی می‌تواند کد پشت کاره را بررسی کرده و در آن مشارکت کند. همچنین آنتناپاد در فروشگاه کاره‌های آزاد و حافظ محرمانگی [اف‌دروید](https://www.f-droid.org/packages/de.danoeh.antennapod/) در دسترس است.

...
* In AntennaPod kannst du einen Ordner wie einen Feed hinzufügen. Gehe zu `Podcast hinzufügen` und tippe auf `Lokalen Ordner hinzufügen`. Dann gehe zu diesem Ordner auf deinem Smartphone:

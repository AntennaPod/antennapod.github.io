...
- **Mit Bluetooth-Geräten verbinden**: Für die Einstellung `Wiedergabe` » `Kopfhörer oder Bluetooth getrennt`, um die Wiedergabe automatisch anzuhalten oder fortzusetzen, wenn das Smartphone eine Verbindung zu einem Bluetooth-Gerät herstellt oder trennt

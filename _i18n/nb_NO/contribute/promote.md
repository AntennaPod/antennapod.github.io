AntennaPod avhenger av gratis markedsføring, jungeltelegrafen og moderat tilstedeværelse i sosiale media. Vi vet at det er rom for forbedring. Det har sikkert du også tenkt på. Hvorfor ikke hjelpe oss å bli bedre? Ditt bidrag i hvilken som helst av disse områdene blir satt pris på.
...
* **Sosiale media** Liker du å finne innfallsvinkler å snakke om prosjektet på samt å planlegge presise og kreative meldinger nå og da? Hjelp oss å nå et bredere publikum på X (Twitter) og Mastodon.
...
* **Grafisk design** Komfortabel med (digitalt) penn og blekk? Hjelp oss å oppfriske nettsiden, kontoer på sosiale medier og annet promoteringsmateriale.

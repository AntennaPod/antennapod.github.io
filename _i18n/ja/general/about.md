...
そうした文脈において、私たちが選択肢を追加することはそれ以外の選択肢が排除されることであると認識しています。そして、選択をしないということはその決定をエンドユーザーに押し付けるということです。（[開発者が安易にそうすべきでない理由についての素晴らしいブログ記事](https://neugierig.org/software/blog/2018/07/options.html)があります。）私たちは素晴らしい体験を生み出すような決定を下すよう最善を尽くすことをお約束します。だって―今晩、何を食べるか、もう決めましたか？
...
FirefoxやSignalなどの他の優れたソフトウェアと同様に、AntennaPodはオープンソースです。これは、誰でもアプリの背後にあるコードを確認して貢献できることを意味します。そして、AntennaPodはオープンソースでプライバシーに配慮した[F-Droidアプリストア](https://f-droid.org/packages/de.danoeh.antennapod/)から入手できます。

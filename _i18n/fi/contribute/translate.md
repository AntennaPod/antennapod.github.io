...
Käännöksiin käytämme Weblaten avoimeen lähdekoodiin perustuvaa alustaa. Kuka tahansa voi rekisteröityä sinne ja [aloittaa AntennaPod kääntämisen](https://hosted.weblate.org/projects/antennapod). Weblaten dokumentaatiosta löydät [kaiken mitä tarvitset kääntämisen aloittamiseen](https://docs.weblate.org/en/latest/user/translating.html){:target="_blank"}.

{% capture img-translationstatus %} {% include image.html alt="

       AntennaPodin graafinen käännösstatus Weblatessa.
...
1. **Yleiset** ja **Lyhyet merkkijonot**: ensimmäiset elementit, jotka käyttäjät näkevät verkkosivulla
1. **Dokumentaatio**: tukimateriaalimme, jotka on saatavissa suoraan sovelluksen kautta
1. **Osallistu** (viimeisenä, koska osallistuminen vaatii englanninkielen perusosaamista)

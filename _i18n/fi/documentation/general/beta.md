...
Jokainen versio AntennaPodista lähetetään beta testaajillemme Google Playn kautta ennen kun se julkaistaan kaikille. Jos olet tarkkasilmäinen ja osaat selittää mikä ei toimi juuri oikein, olisimme erittäin kiitollisia avustasi! Myös jos jaat ajatuksiasi asioista joita voi parantaa voit auttaa tekemään sovellusta vastaamaan sinun ja yhteisön odotuksia. Jätä palautetta luomalla julkaisu [foorumissamme](https://forum.antennapod.org/).

Haluatko siis saada uusimman ja parhaimman ja auttaa saamaan sovellus oikein kunnon kiiltoon? Vieraile vain AntennaPodin sivulla Google Play-kaupassa ja siirry *sovellustuki* sivun alareunassa olevaan **Ryhdy betatestaajaksi**. Tai jos olet tietokoneesi ääressä, voit siirtyä [tähän URL-osoitteeseen](https://play.google.com/apps/testing/de.danoeh.antennapod).

{% include image.html alt= "

     Ryhdy betatestaajaksi – vahvistusikkuna Google Playissa

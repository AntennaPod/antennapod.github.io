...
Kun poistat tämän podcast-asetuksen käytöstä, podcastia ei enää päivitetä, kun podcastit päivittyvät automaattisesti tai kun käynnistät tämän prosessin `Jono`- tai `Jaksot`-näytöltä. Voit silti päivittää kyseisen podcastin, mikä tuo uusia jaksoja AntennaPodiin.

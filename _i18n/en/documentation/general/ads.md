The official versions of AntennaPod **do not insert any ads**. You can even verify this because [AntennaPod's source code is public](https://github.com/AntennaPod/AntennaPod). Apart from that, AntennaPod is developed by volunteers without commercial interest.

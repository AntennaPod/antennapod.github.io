¿Encontraste algún error? Lo sentimos.
...
Si ya actualizaste AntennaPod y buscaste en el foro sin encontrar nada, cuéntanos tu incidencia. Puedes crear una entrada en [nuestro foro](https://forum.antennapod.org/c/bug-report/9). Para hacer esto, necesitas crear una cuenta (si aún no tienes una) o simplemente puedes iniciar sesión con Google.
